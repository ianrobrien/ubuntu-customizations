...
theme_name_application="McOS-MJV-Dark-mode"
...
gsettings set org.gnome.desktop.wm.preferences theme ${theme_name_application}
gsettings set org.gnome.desktop.interface gtk-theme ${theme_name_application}
